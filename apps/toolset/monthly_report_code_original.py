...
def process_monthly_report(project_name, report_date, payment_range_report):
    ...
    Gift_wrap_credits_refunds = round(Refund['gift wrap credits'].sum(),
    ...
    FBA_transaction_fees = round(FBA_Order['fba fees'].sum(), 2)
    ...
    Service_fees = Coupon_fee + Servicefees_without_ADs
